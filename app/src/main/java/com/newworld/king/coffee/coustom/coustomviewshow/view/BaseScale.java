...
public class BaseScale extends View {
    ...
    public BaseScale(Context context) {
        super(context);
    }
    // 3.在构造函数中初始化
    public BaseScale(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public BaseScale(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
