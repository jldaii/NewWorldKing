...
public class BaseRotateTest extends View {
    ...
    public BaseRotateTest(Context context) {
        super(context);
    }
    // 3.在构造函数中初始化
    public BaseRotateTest(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    }

    public BaseRotateTest(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
