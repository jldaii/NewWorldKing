...
public class PathBezierView extends View implements View.OnClickListener{
    ...
    public PathBezierView(Context context, @Nullable AttributeSet attrs) {
        ...
        mMovePointX = mStartPointX; //运动点起始位置
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.drawCircle(mStartPointX,mStartPointY,20,mPaintCircle); // 画圆（坐标点x，y，半径，画笔）
    ...
    public void onClick(View v) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueanimation) {
                PointF pointF = (PointF) valueanimation.getAnimatedValue();
