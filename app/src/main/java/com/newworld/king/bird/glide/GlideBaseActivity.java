...
public class GlideBaseActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        Glide.with(this).load(R.drawable.monkeyking).into(ivGlide2);
...
//        Glide.with(this).load( gifUrl ).placeholder( R.mipmap.ic_launcher).error( R.mipmap.ic_launcher ).into( ivGlide4 );
        Glide.with(this).load(gifUrl).into(ivGlide4);
